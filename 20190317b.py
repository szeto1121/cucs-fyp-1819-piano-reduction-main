...
for i in train_list:
    ...
    models['GRU_1 %d' % i] = km.gru_with_features(features)
progress = ''
...
models = {}
for i in train_list:
    models['GRU_2 without chord %d' % i] = bidirectional_gru(features)
    models['GRU_1 without chord %d' % i] = km.gru_with_features(features)
progress = ''
